                ...
                <div class="col-12 col-md-8 mx-auto">
                    <div class="row d-flex justify-content-center">
                        <div class="col-10 col-md-4 mb-4 mb-md-0 d-flex justify-content-end align-items-end">
                            <img src="img/home/photography.jpg" class="img-fluid" />
                            <span class="position-absolute pb-2 pr-3 text-uppercase text-white">photography</span>
                        </div>
                        <div class="col-10 col-md-4 mb-4 mb-md-0 d-flex justify-content-end align-items-end">
                            <img src="img/home/videography.jpg" class="img-fluid" />
                        ...
                        <div class="col-10 col-md-4 d-flex justify-content-end align-items-end">
                            <img src="img/home/design.jpg" class="img-fluid" />
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-3 p-4">
                    <div class="card">
                        <img src="https://instagram.fcgp3-1.fna.fbcdn.net/vp/502ddef390df4e1a8d94aca97a623c84/5DCF8535/t51.2885-15/e35/14099827_1772585569681944_776159930_n.jpg?_nc_ht=instagram.fcgp3-1.fna.fbcdn.net" class="card-img-top img-fluid" />
                        <div class="card-body">
                            <span class="card-title font-weight-bold px-16">Maju Curated</span>
                            <div class="card-text px-12">
                                <span class="mr-4">24k likes</span>11 Enero 2017
                            </div>
                        </div>
                    </div>
                </div>
